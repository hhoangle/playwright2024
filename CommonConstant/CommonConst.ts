...
function generateRandomFullName(): string {
  const names = ["John", "Jane", "Mary", "James", "Emily", "Michael", "Sarah", "David", "Jessica", "Robert", "Sarah", "William", "Laura", "Richard", "Karen"];
  const surnames = ["Smith", "Johnson", "Williams", "Jones", "Brown", "Davis", "Miller", "Wilson", "Moore", "Taylor", "Anderson", "Thomas", "Jackson", "White", "Harris"];
...
function generateRandomAddress(): string {
  ...
  const streets = ["Ang Mo Kio Ave", "Bedok North St", "Clementi Ave", "Dover Rd", "Eunos Crescent", "Farrer Rd", "Geylang Bahru", "Hougang Ave", "Jurong West St", "Kent Ridge Rd"];
  const postalCodes = ["119077", "569830", "159545", "528765", "460025", "310530", "600040", "680235", "640492", "119260"];
